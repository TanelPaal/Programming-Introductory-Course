...
def test_different_password_with_uppercase():
    ...
    assert password.is_different("WhAAAAAAAAt?!", "THaaaaaaaat.") is False
    assert password.is_different("Lorem Ipsum dolor sit amet", "Helvetica, SF Pro Display, Arial") is True
