...
hours_per_ects = 26
total_study_hours = ects * hours_per_ects

if total_study_hours > weeks * 168:
    print(-1)
else:
    print(f"The student needs to study {total_study_hours / weeks} hours per week to achieve the required ECTS.")
