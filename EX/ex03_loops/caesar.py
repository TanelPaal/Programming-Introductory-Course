...
def encode(message: str, shift: int) -> str:
    ...
    for char in message:
        ...
        if index_in_alphabet == -1:
            ...
            # Calculate the new character index after applying the shift.
            new_char_index = (index_in_alphabet + shift) % len(alphabet)
            # Add the encoded character to the output message.
            encoded_string += alphabet[new_char_index]
